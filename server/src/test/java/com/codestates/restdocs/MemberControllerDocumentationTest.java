...
//                .andExpect(jsonPath("$.data.phone").value(post.getPhone()))
    ...
    public void patchMemberTest() throws Exception {
        // given
        long memberId = 1L;
        MemberPatchDto patch = (MemberPatchDto) StubData.MockMember.getRequestBody(HttpMethod.PATCH);
        String content = toJsonContent(patch);

        MemberResponseDto responseDto = StubData.MockMember.getSingleResponseBody();
...
//                .andExpect(jsonPath("$.password").value(patch.getPassword()))
    ...
    public void getMemberTest() throws Exception {
        ...
        // given
        long memberId = 1L;
        MemberResponseDto response = StubData.MockMember.getSingleResponseBody();
